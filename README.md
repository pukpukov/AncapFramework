...
## Фичи
- Куча удобных вещей для упрощения рутинной разработки, которые реализуются (часто костыльно и уродливо) в 90% плагинов
- Оформление ООП-стиля плагина - написанные с помощью этого фреймворка плагины выглядят намного красивее и гораздо более поддерживаемы
